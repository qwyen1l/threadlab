		...
		try {
	        ...
	        while (true) {
	            ...
	            if (line.startsWith("SUBMITNAME")) {
	            	...
	            	Platform.runLater(()-> { textField.setEditable(true); }); //added
	            	...
	            	final String messageToAdd = line.substring(8) + "\n";
	            	Platform.runLater(()-> { messageArea.appendText(messageToAdd); }); //added
	            }
	        }
